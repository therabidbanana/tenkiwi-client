(ns tenkiwi.games.prompted-by-charge
...
(defn other-panel []
  (let [game-state (re-frame/subscribe [:recharge-other])]
...
(defn scoreboard-panel []
  (let [game-state (re-frame/subscribe [:recharge-scoreboard])]
...
(defn dice-panel []
  (let [game-state (re-frame/subscribe [:recharge-dice])]
...
(defn main-panel []
  (let [game-state (re-frame/subscribe [:recharge-main])]
    (build-main-panel game-state re-frame/dispatch)))

(defn recharge-game-panel []
