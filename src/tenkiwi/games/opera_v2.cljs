...
(defn other-panel []
  (let [game-state (re-frame/subscribe [:opera-v2-other])]
...
(defn scoreboard-panel []
  (let [game-state (re-frame/subscribe [:opera-v2-scoreboard])]
...
(defn dice-panel []
  (let [game-state (re-frame/subscribe [:opera-v2-dice])]
...
(defn main-panel []
  (let [game-state (re-frame/subscribe [:opera-v2-main])]
    (build-main-panel game-state re-frame/dispatch)))

(defn opera-v2-game-panel []
